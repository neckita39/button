...
(function () {
  ...
  var ROOMS = [
    ...
    /* 2 этаж: наша треть справа, переговорки вплотную — общая стена x=70 */
    { id: 'tsvetnaya', name: '2 этаж Цветная', cap: 6, zone: 'f2', floor: 2,
      features: ['Стол', 'ТВ'], accent: '#e0763c', photo: 'photos/inter/IMG_4896.jpg',
      rect: { x: 63, y: 8, w: 7, h: 7 }, door: { x: 66.5, y: 15 },
      interior: [
        { kind: 'tv', x0: 64.5, x1: 68.5 },
        { kind: 'table', rect: { x: 64.8, y: 10.2, w: 3.4, h: 2.6 }, seats: [2, 1, 2, 1] }
      ] },
    { id: 'divany', name: '2 этаж Диваны', cap: 6, zone: 'f2', floor: 2,
      features: ['Диваны'], accent: '#3bb5c9', photo: 'photos/inter/IMG_4893.jpg',
      rect: { x: 70, y: 8, w: 7, h: 7 }, door: { x: 73.5, y: 15 },
      interior: [
        { kind: 'sofa', rect: { x: 71.3, y: 9.4, w: 3.2, h: 1.2 } },
        { kind: 'table', rect: { x: 72.9, y: 11.3, w: 1.8, h: 1 } },
        { kind: 'armchair', x: 72.1, y: 13.3, dir: 'n' },
        { kind: 'armchair', x: 74.9, y: 13.3, dir: 'n' }
      ] }
  ];
  ...
  var WALLS = [
    ...
    /* 2 этаж: наша треть справа (x>58), граница с соседями x=58 (с проёмом),
       общая стена переговорок x=70 — ровно по их смежной грани */
    { a: { x: 0, y: 0 }, b: { x: 40, y: 0 }, h: 40, art: 'deer', floor: 2 },
    { a: { x: 42, y: 0 }, b: { x: 86, y: 0 }, h: 40, floor: 2 },
    { a: { x: 0, y: 0 }, b: { x: 0, y: 24 }, h: 40, floor: 2 },
    { a: { x: 58, y: 0 }, b: { x: 58, y: 13 }, h: 40, floor: 2, phase: 2 },
    { a: { x: 58, y: 17 }, b: { x: 58, y: 24 }, h: 40, floor: 2, phase: 2 },
    { a: { x: 70, y: 8 }, b: { x: 70, y: 15 }, h: 40, floor: 2, phase: 4 }
  ];
  ...
  var DECOR = [
    ...
    /* 2 этаж: лифт в той же шахте (у соседей) + пуфики в нашем коридоре */
    { id: 'lift2', kind: 'lift', name: 'Лифт', floor: 2,
      rect: { x: 34, y: 19, w: 9, h: 4.5 } },
    { id: 'f2pouf1', kind: 'pouf', color: '#e8c22e', floor: 2,
      rect: { x: 60, y: 19, w: 1.1, h: 1.1 } },
    { id: 'f2pouf2', kind: 'pouf', color: '#e05a6e', floor: 2,
      rect: { x: 61.4, y: 19.8, w: 1.1, h: 1.1 } },
    { id: 'f2pouf3', kind: 'pouf', color: '#59b93c', floor: 2,
      rect: { x: 80.5, y: 18.6, w: 1.1, h: 1.1 } }
  ];
  ...
  function makeSchedule() {
    return {
      ...
      tsvetnaya: [
        ev('cv1', 'Дизайн-ревью', 'Настя В.', ['Настя В.', 'Дима Р.'], 810, 870, { checkedInAt: 812 }),
        ev('cv2', 'Планёрка поддержки', 'Женя Л.', ['Женя Л.', 'Оля К.'], 990, 1050, {})
      ],
      divany: [
        ev('dv1', '1:1 у диванов', 'Дима Р.', ['Дима Р.', 'Стажёр'], 870, 900, { checkedInAt: 871 }),
        ev('dv2', 'Книжный клуб', 'HR', ['HR'], 1080, 1140, {})
      ]
    };
  }
